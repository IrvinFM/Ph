...
<body class="min-h-screen">
    ...
    <!-- Barra lateral -->
    <div class="fixed inset-y-0 left-0 w-70 bg-white shadow-lg">
        <div class="flex items-center justify-center h-10 px-4 border-b">
        ...
        <nav class="p-4">
            <div class="space-y-1">
                ...
                <img src="../image/icons/branch.svg" alt="Ícono de Sedes" class="mr-3" style="width: 1.25em; height: 1.25em;">Sedes
                 ...
                 <a href="#" data-section= "profesor" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-600">
                <img src="../image/icons/teacher.svg" alt="Ícono de Sedes" class="mr-3" style="width: 1.25em; height: 1.25em;">
                    <i></i>Profesores
                </a>
                <a href="#" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-600">
...
<script src="https://cdn.datatables.net/1.13.6/js/dataTables.bootstrap5.min.js"></script>
    ...
    <script src="../Js/profesores/cargarProf.js"></script>
    ...
    <script src="../Js/profesores/editProf.js"></script>
    <script src="../Js/profesores/nuevoProf.js"></script>
